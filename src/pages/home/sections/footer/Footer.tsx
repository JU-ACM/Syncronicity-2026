...
//       {/* ================= TOP SECTION ================= */}
//       <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-20 px-10">
...
export default function ContactSection() {
  return (
    <section className="relative w-full bg-gradient-to-br from-[#eef7fb] to-[#b7dbe8]">
      ...
      <div className="mx-auto max-w-6xl flex justify-center items-start gap-16 py-20 px-10">
  ...
  <div className="max-w-lg text-left">
    ...
    <p className="text-base text-gray-700 font-bold leading-relaxed mb-6 max-w-sm">
      Have questions about membership, events, or collaborations? Reach out to the
      Jadavpur University ACM Student Chapter and we’ll get back to you.
    </p>
    ...
    <div className="space-y-4 text-sm text-black">
      ...
      <div className="w-full px-10 lg:px-10 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-12">

          {/* LEFT */}
          <div className="text-black max-w-sm justify-self-start">
          ...
          <div className="flex justify-end-safe">
            ...
            src={Robot}
            alt="Robot"
            className="w-100 lg:w-100 drop-shadow-xl -mb-10"
            />
          </div>

          {/* RIGHT QUICK LINKS */}

          <div className="text-black max-w-sm ml-auto justify-self-end text-left">

  ...
  return (
    <section className="footer-class relative pt-40 w-full bg-linear-to-br from-[#eef7fb] to-[#b7dbe8]">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 pb-12 pt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center md:items-start gap-12">
          {/* Left: Logo & Description */}
          <div className="text-black max-w-sm text-center lg:text-left mx-auto lg:mx-0">
            <div className="flex justify-center lg:justify-start mb-4">
              <PrimaryColoredLogo size={250} />
            </div>

            <p className="text-sm md:text-base font-euclid leading-relaxed opacity-90 mb-6">
            ...
            <div className="flex justify-center lg:justify-start items-center gap-5">
              ...
              <a
                ...
                className="hover:opacity-50 transition-opacity w-8 h-8"
              >
                <svg viewBox="-2.16 -2.16 28.32 28.32" fill="#000000">
                  <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:opacity-50 transition-opacity w-8.5 h-8.5"
              >
          ...
          <div className="hidden lg:flex justify-center items-end h-full">
            <motion.img
              src={Robot}
              alt="Friendly Robot"
              className="absolute w-100 xl:w-120 -mb-12 origin-bottom"
